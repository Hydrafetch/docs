...
<CardGroup cols={2}>
  <Card title="Build a RAG corpus" icon="/icons/layers.svg" href="/blueprints/rag-corpus">
    List a site's URLs, keep the ones worth having, and fetch them as clean Markdown ready to chunk.
  </Card>
  <Card title="Turn a catalogue into rows" icon="/icons/table.svg" href="/blueprints/catalogue-to-rows">
    Point at a set of pages, describe the fields, get typed records instead of prose.
  </Card>
  <Card title="Read PDFs and documents" icon="/icons/file-content.svg" href="/blueprints/documents-to-markdown">
    Send a document URL to the same endpoint as a web page and get Markdown back, tables intact.
  </Card>
  <Card title="Watch a site for changes" icon="/icons/bell.svg" href="/blueprints/watch-a-site">
...
<CardGroup cols={2}>
  <Card title="Answer with sources" icon="/icons/magnifier.svg" href="/blueprints/answer-with-sources">
    Search the web and get the pages back already fetched, so a model answers from text it can cite.
  </Card>
  <Card title="Give an agent live web access" icon="/icons/robot.svg" href="/blueprints/agent-web-access">
...
<CardGroup cols={2}>
  <Card title="Build a local business directory" icon="/icons/location.svg" href="/blueprints/local-business-directory">
    Start from a category and a city, and get a row per location with hours, services and a real address.
  </Card>
  <Card title="Enrich a list of companies" icon="/icons/building.svg" href="/blueprints/lead-enrichment">
    Turn a column of domains into names, descriptions, industries, logos and socials.
  </Card>
  <Card title="Match a customer's brand" icon="/icons/palette.svg" href="/blueprints/match-a-customer-brand">
    Read a customer's colours, fonts and logo from their own site instead of asking them to upload one.
  </Card>
  <Card title="Show company logos" icon="/icons/image.svg" href="/blueprints/directory-logos">
