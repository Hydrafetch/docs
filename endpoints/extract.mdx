...
<CardGroup cols={2}>
  <Card title="Per-field confidence + evidence" icon="/icons/shield.svg">
  ...
  <Card title="Merge into one collection" icon="/icons/layers.svg">
...
<CardGroup cols={2}>
  <Card title="Search" icon="/icons/magnifier.svg" href="/endpoints/search">
