...
<AccordionGroup>
  <Accordion title="400 — Validation error" icon="/icons/circle-warning.svg">
  ...
  <Accordion title="401 — Unauthorized" icon="/icons/key.svg">
  ...
  <Accordion title="402 — Insufficient credits" icon="/icons/coins.svg">
  ...
  <Accordion title="404 — Not found" icon="/icons/magnifier.svg">
  ...
  <Accordion title="422 — Origin unreachable" icon="/icons/link-broken.svg">
  ...
  <Accordion title="429 — Rate limited" icon="/icons/gauge.svg">
  ...
  <Accordion title="504 — Timed out" icon="/icons/clock.svg">
  ...
  <Accordion title="5xx — Server error" icon="/icons/server.svg">
